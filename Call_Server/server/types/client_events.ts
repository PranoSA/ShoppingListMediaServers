...
interface ClientToServerEvents {
    ...
    */
    getProducers:(callback:(e:ProducerResponseArgs) => void) => void;
    ...
    */
    ...
    consume:(a:ConsumeParameters, callback:(e:ConsumeRequestCallbackParams)=>void ) => void;
    consumerresume:(a:ConsumeResumeParams)=>void;


  }   

type ProducerResponseArgs = string[]
